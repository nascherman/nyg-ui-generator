/*
 This script will try to detect index file or ask user to choose
 */
  ...
  return new Promise((resolve, reject) => {
    try {
      ...
      if (!configs.rename || configs.rename === indexFile) {
        ...
        if (choices.length > 1) {
          !Object.keys(configs).length && console.warn(chalk.bgMagenta('WARN:'), chalk.magenta(`Cannot find index.js as well as 'rename' information from ${process.cwd()}/nyg-cfg.json.`));
